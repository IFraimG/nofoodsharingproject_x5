...
public class SetterAdvrsFactory implements ViewModelProvider.Factory {
    private final Application application;
    private final AdvertsRepository advertsRepository;
    private final MapRepository mapRepository;

    public SetterAdvrsFactory(Application application, AdvertsRepository advertsRepository, MapRepository mapRepository) {
