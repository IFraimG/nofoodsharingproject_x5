...
| FaqActivity | Faq |
| GetterActivity | Основная активности "принимающего" пользователя |
| GetterNewAdvertActivity | Создание нобъявление "принимающим" пользователем |
| MainActivity | Основная активность |
| MainAuthActivity | Основная активность регистрации |
| SetterActivity | Основная активности "отдающего" пользователя |
| SetterAdvertActivity | Просмотр объявления "принимающего" пользователя "отдающим" |
| SetterHelpFinishActivity | Сообщение об успешном пожертвовании и переход в vk чекбек |
| GetterAuthfragment | Фрагмент авторизации "принимающего" пользователя|
| MainAuthFragment | Основной Фрагмент авторизации|
| SetterAuthFragment|  Фрагмент создания "отдающего" пользователя |
| SetterLoginAuthFragment| Фрагмент авторизации "отдающего" пользователя |
| GetterAdvsFragment | Раздел "объявления" в аккаунте "принимающего" в приложении|
| GetterProfileFragment | Раздел "профиль" в аккаунте "пинимающего" в приложении|
| SetterAdvsFragment | Раздел "объявления" в аккаунте "отдающего" в приложении|
| SetterProfileFragment | Раздел "профиль" в аккаунте "отдающего" в приложении|
...
| GetterNotificationsAdapter | Адаптер уведомлений "принимающего" пользователя|
| MessagesAdapter | Адаптер сообщений|
| SetterAdvertListAdapter | Адаптер списка объявлений у "отдающего" пользователя |
